...
#ifndef COMMON_BASE_BYTE_STREAM_H
#define COMMON_BASE_BYTE_STREAM_H
...
class YRK_EXPORT_DLL ByteStream : private BaseUncopy
{
public:
...
class YRK_EXPORT_DLL OBStream : public ByteStream
{
public:
...
class YRK_EXPORT_DLL IBStream : public ByteStream
{
public:
...
#endif // COMMON_BASE_BYTE_STREAM_H
